...
var HTMLmobile = "<div id='topContacts'><li class='flex-item'><span class='orange-text'>mobile</span><span class='white-text'>%data%</span></li>";
var HTMLemail = "<li class='flex-item'><span class='orange-text'>email</span><span class='white-text'>%data%</span></li>";
var HTMLtwitter = "<li class='flex-item'><span class='orange-text'>twitter</span><span class='white-text'>%data%</span></li>";
var HTMLgithub = "<li class='flex-item'><span class='orange-text'>github</span><span class='white-text'>%data%</span></li>";
var HTMLblog = "<li class='flex-item'><span class='orange-text'>blog</span><span class='white-text'>%data%</span></li>";
var HTMLlocation = "<li class='flex-item'><span class='orange-text'>location</span><span class='white-text'>%data%</span></li>";
var HTMLlinkedIn = "<a href='#'>%data%</a>";
...
var HTMLonlineClassesStart = "<div class='course-entry'></div>";
...
$(document).ready(function() {
  $('button').click(function() {
    //inName on line 68 originaly had no parameter so I added (name) and it works.
...
$(document).click(function(loc) {
  // Each time the page is clicked, x and y values are stored in the variables x & y.
  var x = loc.pageX;
  var y = loc.pageY;
  ...
  */
  function createMapMarker(placeData) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      //Use open method to open each overlay.
